...
import ModalButton from "../../../BasicModal/Order/ModalButton";
import { exportOrdersExcel } from "../../../../services/services";

export default function OrderRegistration(props: ICardProps) {
    ...
    return (
        ...
        >
            ...
            >
                <ModalButton
                    gap='2rem'
                    label='Adicionar Pedidos em Lote'
                    icon={<FaPlus />}
