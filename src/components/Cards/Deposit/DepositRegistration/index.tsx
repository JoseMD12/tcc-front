...
import ModalButton from "../../../BasicModal/Deposit/ModalButton";
import { exportDepositsExcel } from "../../../../services/services";

export default function DepositRegistration(props: ICardProps) {
    ...
    return (
        ...
        >
            ...
            >
                <ModalButton
                    gap='2rem'
                    label='Adicionar Depósitos em Lote'
                    icon={<FaPlus />}
                ...
                <ModalButton
                    gap='2rem'
                    label='Remover Depósitos em Lote'
                    icon={<LuTrash />}
